...
if($account) {
    ...
    $curl = new \Curl\Curl('https://graph.keepa.com'.$path);
    ...
    if($method == 'GET') {
        ...
        if(isset($responseHeaders['location'])) {
            header('Location: '.str_replace(['https://graph.keepa.com'], [$cdnDomain], $responseHeaders['location']));
            die();
        }
        ...
        $response = str_replace([
            ...
            'wss://wss.privatesupport.net:8015/apps/cloud/'
        ], $response);
         
    //   $response = str_replace([
    //         'dyn-2.keepa.amztoolz.com',
    //         'wss://"+K[J]+"/apps/cloud/?app=keepaWebsite&version=1.6',
    //         'wss://"+server[0]+"/apps/cloud/?app=keepaWebsite&version=1.6'
            
    //     ], [

    //       'dyn.keepa.amztoolz.com',
    //       'wss://wss.privatesupport.net:8015/apps/cloud/?app=keepaWebsite&version=1.6',
    //       'wss://wss.privatesupport.net:8015/apps/cloud/?app=keepaWebsite&version=1.6'
    ...
    //     ], $response);
        ...
        //   'dyn.keepa.amztoolz.com',
        //   'wss://dyn.keepa.amztoolz.com/apps/cloud/?app=keepaWebsite&version=1.6',
        //   'wss://dyn.keepa.amztoolz.com/apps/cloud/?app=keepaWebsite&version=1.6'
